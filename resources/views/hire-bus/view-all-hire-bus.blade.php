...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">View All Hire Buses</li>
		</ol>
	</section>
			...
			<div class="col-xs-12">
				<div class="box">
					<!-- <div class="box-header">
						<a href="{{url('add-new-hire-bus')}}"><button type="submit" class="btn btn-info"><i class="fa fa-list"></i>&emsp;Add Hire Bus</button></a>
					</div> -->
					<!-- /.box-header -->
					<div class="box-body">
