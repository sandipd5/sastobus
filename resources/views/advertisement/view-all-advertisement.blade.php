...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">View All Advertisements</li>
		</ol>
	</section>
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<a href="{{url('add-new-advertisement')}}"><button type="submit" class="btn btn-info"><i class="fa fa-list"></i>&emsp;Add Advetisement</button></a>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								<tr>
									<td>1</td>
									<td>John Doe Advert</td>
									<td>Advert One</td>
									<td>
										<div class="img-fluid adminlte-form-image"><img src="{{url('public/images/photo1.png')}}" alt=""></div>
									</td>
								...
								<tr>
									<td>2</td>
									<td>Mellisa Doe Advert</td>
									<td>Advert Two</td>
									<td>
										<div class="img-fluid adminlte-form-image"><img src="{{url('public/images/photo2.png')}}" alt=""></div>
									</td>
									<td>Limit two lines at max</td>
									<td>Page</td>
									<td>Link</td>
